...
a3 = int(input("Gosto de aprender novas linguagens de programação.\n"))
a4 = int(input("Prefiro trabalhar com lógica e estruturação de código.\n"))
a5 = int(input("Tenho paciência para depurar erros e otimizar código.\n"))

b1 = int(input("Gosto de pensar na experiência do usuário ao usar um sistema.\n"))
b2 = int(input("Tenho interesse em pesquisa de mercado e comportamento do usuário.\n"))
b3 = int(input("Me interesso por criar soluções inovadoras e intuitivas.\n"))
b4 = int(input("Gosto de trabalhar com design, wireframes ou prototipagem.\n"))
b5 = int(input("Quero entender e definir estratégias para melhorar produtos digitais.\n"))

c1 = int(input("Gosto de testar e garantir que sistemas funcionem corretamente.\n"))
c2 = int(input("Tenho interesse em encontrar erros e melhorar a estabilidade dos produtos.\n"))
c3 = int(input("Acredito que testes automatizados ajudam a evitar falhas em sistemas.\n"))
c4 = int(input("Gosto de seguir padrões e documentar processos para garantir qualidade.\n"))
c5 = int(input("Quero trabalhar garantindo que um software funcione bem para todos os usuários.\n"))
